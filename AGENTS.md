...
- **Include effects tail**: Preserves a cold start and waits for the final scheduled gate to end. Auto estimates active synth and decaying-effect release, capped at 10 seconds; Custom appends the selected 0–10 second duration; legacy settings use the prior explicit 2-second tail.
