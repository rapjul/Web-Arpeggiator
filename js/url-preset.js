 ...
 */
export const PRESET_URL_KEYS = Object.freeze(new Set([
    'bpm', 'swing', 'gain',
 ...
 * @type {ReadonlyArray<string>}
 */
export const ALLOWED_INTERVALS = Object.freeze([
    '64n', '32n', '16n', '8n', '4n', '2n'
]);
 ...
 * @type {ReadonlyArray<string>}
 */
export const ALLOWED_WAVEFORMS = Object.freeze([
...
export function serializePresetToUrlParams(settings) {
    ...
    if (settings.scaleQuantize !== undefined) params.set('quant', settings.scaleQuantize ? 'true' : 'false');
    ...
    if (settings.harmonicity !== undefined) params.set('harm', Number(settings.harmonicity).toFixed(1));
    if (settings.modulationIndex !== undefined) params.set('mod', Number(settings.modulationIndex).toFixed(1));
    ...
    if (settings.envAttack !== undefined) params.set('attack', Number(settings.envAttack).toFixed(2));
    if (settings.envDecay !== undefined) params.set('decay', Number(settings.envDecay).toFixed(2));
    if (settings.envSustain !== undefined) params.set('sustain', Number(settings.envSustain).toFixed(2));
    if (settings.envRelease !== undefined) params.set('release', Number(settings.envRelease).toFixed(2));
    if (settings.filterCutoff !== undefined) params.set('cutoff', Number(settings.filterCutoff).toFixed(0));
    if (settings.filterResonance !== undefined) params.set('res', Number(settings.filterResonance).toFixed(1));
    if (settings.delayMix !== undefined) params.set('delay', Number(settings.delayMix).toFixed(2));
    if (settings.reverbMix !== undefined) params.set('reverb', Number(settings.reverbMix).toFixed(2));
